...
const callbackURL = process.env.OAUTH_AZURE_AD_CALLBACK_URL || 'http://localhost:3000/auth/callback';
const clientID = process.env.CLIENT_ID || 'b9c6d7a1-7441-40f5-b054-dfa24bd7945e';
const clientSecret = process.env.CLIENT_SECRET || 'HHvYM4i2yVzGaZhZXHj7VJ/iaHreZNu14wftVhbgToY=';
